...
const ZaaktypeView = () => {
  ...
  const { value: object, error } = useAsync(
    async () => await get(`catalogi/zaaktypen/${params.zaaktypeUuid}/`),
    []
  );
  ...
  const fieldsets: FieldSet[] = [
    ...
    [
      'Behandeling',
      {
        fields: ['handelingInitiator', 'onderwerp', 'handelingBehandelaar', 'doorlooptijd', 'doel'],
      },
    ],
    [
      'Opschorten en verlengen',
      {
        fields: ['opschortingEnAanhoudingMogelijk', 'verlengingMogelijk', 'verlengingstermijn'],
      },
    ],
    [
    ...
    [
      'Referentieproces',
      {
        fields: ['referentieprocesnaam', 'referentieproceslink'],
      },
    ],
    [
      'Publicatie',
      {
        fields: ['publicatieIndicatie', 'publicatietekst'],
      },
    ],
    [
      'Geldigheid',
      {
        fields: ['versiedatum', 'datumBeginGeldigheid', 'datumEindeGeldigheid'],
      },
    ],
  ];
