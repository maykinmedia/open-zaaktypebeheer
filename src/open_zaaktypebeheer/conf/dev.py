...
os.environ.setdefault(
    "SECRET_KEY",
    "django-insecure-!bkx+tx18&lvp(@_9)9ut(y(keqho*zhz1&^sq$qgq9*i=__w(",
)
os.environ.setdefault("IS_HTTPS", "no")
os.environ.setdefault("VERSION_TAG", "dev")

os.environ.setdefault("DB_NAME", "open_zaaktypebeheer")
os.environ.setdefault("DB_USER", "open_zaaktypebeheer")
os.environ.setdefault("DB_PASSWORD", "open_zaaktypebeheer")
